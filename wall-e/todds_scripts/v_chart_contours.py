...
#Print Header
print("video,frame,x,y,area,minI,maxI,meanI" )
...
#analyze contours for left video
	...
	if cv2.contourArea(c) > minArea:
	     ...
	     min_val, max_val, min_loc, max_loc = cv2.minMaxLoc(imgray,mask = mask)
             print("left," + str(frametext) + "," + str(cX) + "," + str(400-cY) + "," + str(cv2.contourArea(c) ) + "," + 
...
#analyze contours for right video
	...
	if cv2.contourArea(d) > minArea:
	     ...
	     min_val2, max_val2, min_loc2, max_loc2 = cv2.minMaxLoc(imgray2,mask = mask)
             print("right," + str(frametext) + "," + str(cX2) + "," + str(400-cY2) + "," + str(cv2.contourArea(d) ) + "," + 
